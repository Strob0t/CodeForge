...
const de: Translations = {
  ...
  "app.nav.section.ai": "KI & Agenten",
  "app.nav.section.knowledge": "Wissen",
  "app.nav.section.system": "System",
  "app.nav.aiConfig": "KI-Konfiguration",
  "app.nav.knowledge": "Wissen",
  "activity.tab.live": "Live",
  "activity.tab.audit": "Pruefprotokoll",
  "ai.tab.models": "Modelle",
  "ai.tab.modes": "Modi",
  "knowledge.tab.bases": "Wissensdatenbanken",
  "knowledge.tab.scopes": "Bereiche",
  ...
  // -- Dashboard KPI / Health / Charts / Timeline --
  "dashboard.kpi.costToday": "Kosten Heute",
  "dashboard.kpi.activeRuns": "Aktive Runs",
  "dashboard.kpi.successRate": "Erfolgsrate (7T)",
  "dashboard.kpi.activeAgents": "Aktive Agenten",
  "dashboard.kpi.avgCostRun": "Durchschn. Kosten/Run",
  "dashboard.kpi.tokenUsage": "Tokens Heute",
  "dashboard.kpi.errorRate": "Fehlerrate (24h)",
  "dashboard.health.title": "Gesundheitswert",
  "dashboard.health.successRate": "Erfolgsrate (7T)",
  "dashboard.health.errorRate": "Fehlerrate (24h)",
  "dashboard.health.activity": "Letzte Aktivität",
  "dashboard.health.taskVelocity": "Aufgabengeschwindigkeit",
  "dashboard.health.costStability": "Kostenstabilität",
  "dashboard.charts.title": "Diagramme",
  "dashboard.charts.costTrend": "Kostentrend",
  "dashboard.charts.runOutcomes": "Run-Ergebnisse",
  "dashboard.charts.agentPerf": "Agenten",
  "dashboard.charts.modelUsage": "Modelle",
  "dashboard.charts.costByProject": "Kosten/Projekt",
  ...
  "costs.emptyDescription": "Kostendaten erscheinen nach dem ersten Agenten-Lauf.",
  ...
  "plan.review.autoProceed": "Automatisch",
  "plan.review.routedToReview": "Zur Pr\u00fcfung weitergeleitet",
  "plan.review.confidence": "Konfidenz",
  "plan.review.reason": "Grund",
  "plan.review.reviewers": "Vorgeschlagene Pr\u00fcfer",
  "plan.review.evaluate": "Bewerten",
  "plan.review.evaluating": "Wird bewertet...",
  "plan.flow.title": "Ausf\u00fchrungsfluss",
  "plan.flow.pending": "Ausstehend",
  "plan.flow.running": "L\u00e4uft",
  "plan.flow.completed": "Abgeschlossen",
  "plan.flow.failed": "Fehlgeschlagen",
  "plan.flow.review": "In Pr\u00fcfung",
  "plan.flow.noSteps": "Keine Schritte in diesem Plan",
  "plan.step.input": "Eingabe",
  "plan.step.output": "Ausgabe",
  "plan.step.cost": "Kosten",
  "plan.step.tokens": "Tokens",
  "plan.step.reviewDecision": "Pr\u00fcfungsentscheidung",
  "plan.step.debate": "Debatte",
  "plan.step.debateStarted": "Debatte l\u00e4uft",
  "plan.step.debateCompleted": "Debatte abgeschlossen",
  "plan.step.debateFailed": "Debatte fehlgeschlagen",
  "plan.step.proponent": "Bef\u00fcrworter",
  "plan.step.moderator": "Moderator",
  "plan.step.synthesis": "Synthese",
  ...
  "roadmap.deleteTitle": "Roadmap lu00f6schen",
  ...
  "featuremap.featureCreated": "Feature erstellt",
  "featuremap.featureUpdated": "Feature aktualisiert",
  "featuremap.featureDeleted": "Feature gelöscht",
  "featuremap.featureMoved": "Feature in Meilenstein verschoben",
  "featuremap.featureReordered": "Feature umsortiert",
  "featuremap.milestoneCreated": "Meilenstein erstellt",
  "featuremap.createFailed": "Erstellen fehlgeschlagen",
  "featuremap.updateFailed": "Aktualisieren fehlgeschlagen",
  ...
  "mcp.emptyDescription": "Starte, indem du deinen ersten MCP-Server hinzufuegst.",
  ...
  "mcp.test": "Testen",
  "mcp.testing": "Teste...",
  "mcp.testingConnection": "Verbindung wird getestet...",
  "mcp.testSuccess": "Verbindung erfolgreich",
  "mcp.testSuccessTools": "Verbunden — {{count}} Tools entdeckt",
  ...
  "prompts.emptyDescription": "Fuege Prompt-Sektionen hinzu, um das Agenten-Verhalten anzupassen.",
  ...
  "benchmark.compareResults": "Vergleichsergebnisse",
  "benchmark.metric": "Metrik",
  ...
  "benchmark.systemScore": "System-Score",
  "benchmark.systemCost": "Systemkosten",
  "benchmark.noFallbacks": "Keine Fallback-Ereignisse aufgezeichnet.",
  "benchmark.taskId": "Aufgabe",
  "benchmark.primary": "Primaer",
  "benchmark.fallbackTo": "Fallback",
  "benchmark.reason": "Grund",
  "benchmark.avgScore": "Durchschn. Score",
  "benchmark.avgCost": "Durchschn. Kosten",
  "benchmark.percentage": "Anteil",
  ...
  "files.folderNamePlaceholder": "z.B. src/components",
  "files.createFolderSuccess": "Ordner {{name}} erstellt",
  "files.createFolderFailed": "Ordner konnte nicht erstellt werden",
  "files.saved": "{{name}} gespeichert",
  "files.saveFailed": "Datei konnte nicht gespeichert werden",
  "files.openFailed": "Datei konnte nicht geoeffnet werden",
  "files.renamed": "Umbenannt zu {{name}}",
  "files.renameFailed": "Umbenennung fehlgeschlagen",
  "files.deleted": "{{path}} geloescht",
  "files.deleteFailed": "Loeschen fehlgeschlagen",
  "files.addToContext": "Zum Kontext hinzufuegen",
  "files.addedToContext": "Zum Kontext hinzugefuegt: {{path}}",
  "files.rename": "Umbenennen",
  "files.newName": "Neuer Name",
  "files.newNamePlaceholder": "Neuen Namen eingeben",
  "files.deleteFile": "Datei loeschen",
  "files.deleteFolder": "Ordner loeschen",
  "files.deleteConfirm": "Wirklich loeschen",
  "files.deleteFolderWarning": "Alle Dateien im Ordner werden geloescht.",
  "files.expandAll": "Alle aufklappen",
  "files.collapseAll": "Alle zuklappen",
  ...
  "quarantine.description":
    "Ueberpruefen und Verwalten von Nachrichten, die vom Vertrauenssystem markiert wurden.",
  ...
  "microagents.description":
    "Verwaltung von triggerbasierten Mikroagenten und wiederverwendbaren Skill-Mustern.",
  "microagents.tab.microagents": "Mikroagenten",
  "microagents.tab.skills": "Skills",
  "microagents.selectProject": "Projekt auswaehlen",
  "microagents.selectProjectFirst":
    "Waehlen Sie ein Projekt, um Mikroagenten und Skills zu verwalten.",
  ...
  "microagents.form.promptHint":
    "Anweisungs-Prompt, der bei Trigger-Uebereinstimmung eingefuegt wird.",
  ...
  // -- Routing-Statistiken (Phase 29) -----------------------------------------
  "app.nav.routing": "Routing",
  "routing.title": "Modell-Routing",
  "routing.subtitle": "Intelligente Modellauswahl-Statistiken und Ergebnisse.",
  "routing.stats": "Leistungsstatistiken",
  ...
  "routing.stats.refreshed": "Statistiken aktualisiert.",
  "routing.filter.taskType": "Aufgabentyp",
  "routing.filter.tier": "Komplexitaetsstufe",
  "routing.filter.all": "Alle",
  "routing.outcomes": "Letzte Ergebnisse",
  "routing.outcomes.empty": "Keine Routing-Ergebnisse aufgezeichnet",
  "routing.outcomes.record": "Ergebnis erfassen",
  "routing.field.modelName": "Modell",
  "routing.field.taskType": "Aufgabentyp",
  "routing.field.tier": "Stufe",
  "routing.field.success": "Erfolg",
  "routing.field.qualityScore": "Qualitaet",
  "routing.field.costUsd": "Kosten (USD)",
  "routing.field.latencyMs": "Latenz (ms)",
  "routing.field.tokensIn": "Tokens Ein",
  "routing.field.tokensOut": "Tokens Aus",
  "routing.field.routingLayer": "Schicht",
  "routing.field.avgReward": "Durchschn. Reward",
  "routing.field.trials": "Versuche",
  "routing.recorded": "Ergebnis erfasst.",
  "routing.error.fetchFailed": "Routing-Daten konnten nicht geladen werden.",
