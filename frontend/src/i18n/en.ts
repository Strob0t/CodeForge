...
const en = {
  ...
  "teams.empty": "No teams yet. Create one to coordinate multiple agents.",
  "teams.members": "{{count}} members",
  "teams.memberList": "Members",
  "teams.sharedContext": "Shared Context",
  "teams.noSharedContext": "No shared context items yet.",
  "teams.deleteAria": "Delete team {{name}}",
  "teams.form.name": "Team name",
  "teams.form.namePlaceholder": "My Agent Team",
  "teams.form.protocol": "Protocol",
  "teams.form.members": "Members",
  "teams.form.addMember": "+ Add Member",
  "teams.form.selectAgent": "Select agent...",
  "teams.form.selectRole": "Select role",
  "teams.form.removeMemberAria": "Remove member",
  "teams.form.create": "Create Team",
  "teams.role.coder": "Coder",
  "teams.role.reviewer": "Reviewer",
  "teams.role.tester": "Tester",
  "teams.role.documenter": "Documenter",
  "teams.role.planner": "Planner",
