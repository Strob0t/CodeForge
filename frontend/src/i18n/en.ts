...
const en = {
  ...
  "app.nav.section.ai": "AI & Agents",
  "app.nav.section.knowledge": "Knowledge",
  "app.nav.section.system": "System",
  "app.nav.aiConfig": "AI Config",
  "app.nav.knowledge": "Knowledge",
  "activity.tab.live": "Live",
  "activity.tab.audit": "Audit Trail",
  "ai.tab.models": "Models",
  "ai.tab.modes": "Modes",
  "knowledge.tab.bases": "Knowledge Bases",
  "knowledge.tab.scopes": "Scopes",
  ...
  "dashboard.batch.select": "Select",
  "dashboard.batch.cancel": "Cancel",
  "dashboard.batch.selectAll": "Select All",
  "dashboard.batch.deselectAll": "Deselect All",
  "dashboard.batch.delete": "Delete Selected",
  "dashboard.batch.pull": "Pull Selected",
  "dashboard.batch.status": "Check Status",
  "dashboard.batch.selected": "{{count}} selected",
  "dashboard.batch.confirmDelete": "Delete {{count}} selected projects? This cannot be undone.",
  "dashboard.batch.deleteSuccess": "Batch delete completed.",
  "dashboard.batch.pullSuccess": "Batch pull completed.",
  "dashboard.batch.statusSuccess": "Status check completed.",
  "dashboard.batch.failed": "Batch operation failed.",
  ...
  "costs.emptyDescription": "Cost data will appear after your first agent run.",
  ...
  "costs.byTool": "Cost by Tool",
  "costs.calls_one": "{{count}} call",
  "costs.calls_other": "{{count}} calls",
  ...
  "plan.review.autoProceed": "Auto-proceed",
  "plan.review.routedToReview": "Routed to review",
  "plan.review.confidence": "Confidence",
  "plan.review.reason": "Reason",
  "plan.review.reviewers": "Suggested reviewers",
  "plan.review.evaluate": "Evaluate",
  "plan.review.evaluating": "Evaluating...",
  "plan.flow.title": "Execution Flow",
  "plan.flow.pending": "Pending",
  "plan.flow.running": "Running",
  "plan.flow.completed": "Completed",
  "plan.flow.failed": "Failed",
  "plan.flow.review": "In Review",
  "plan.flow.noSteps": "No steps in this plan",
  "plan.step.input": "Input",
  "plan.step.output": "Output",
  "plan.step.cost": "Cost",
  "plan.step.tokens": "Tokens",
  "plan.step.reviewDecision": "Review Decision",
  "plan.step.debate": "Debate",
  "plan.step.debateStarted": "Debate in progress",
  "plan.step.debateCompleted": "Debate completed",
  "plan.step.debateFailed": "Debate failed",
  "plan.step.proponent": "Proponent",
  "plan.step.moderator": "Moderator",
  "plan.step.synthesis": "Synthesis",
  ...
  "roadmap.deleteTitle": "Delete Roadmap",
  ...
  "featuremap.featureCreated": "Feature created",
  "featuremap.featureUpdated": "Feature updated",
  "featuremap.featureDeleted": "Feature deleted",
  "featuremap.featureMoved": "Feature moved to milestone",
  "featuremap.featureReordered": "Feature reordered",
  "featuremap.milestoneCreated": "Milestone created",
  "featuremap.createFailed": "Failed to create",
  "featuremap.updateFailed": "Failed to update",
  ...
  "detail.tab.trajectory": "Trajectory",
  ...
  "trajectory.selectRun": "Select a run to view its trajectory",
  ...
  "simulator.description":
    "Debug what context an agent would receive for a given query. Adjust retrieval weights and token budget to see how results change.",
  "simulator.query": "Query",
  "simulator.queryPlaceholder": "What would the agent search for?",
  "simulator.topK": "Top K",
  "simulator.tokenBudget": "Token Budget",
  "simulator.bm25Weight": "BM25 Weight",
  "simulator.semanticWeight": "Semantic Weight",
  "simulator.agentMode": "Agent search (query expansion)",
  "simulator.includeGraph": "Include GraphRAG",
  "simulator.search": "Simulate",
  "simulator.searching": "Searching...",
  "simulator.error": "Search failed",
  "simulator.expandedQueries": "Expanded queries",
  "simulator.budgetUsage": "Token Budget Usage",
  "simulator.tokens": "tokens",
  "simulator.fitsInBudget": "results fit in budget",
  "simulator.overBudget": "Over budget",
  "simulator.withinBudget": "Within budget",
  "simulator.toggleResult": "Toggle result: {{path}}",
  "simulator.bm25Rank": "BM25 rank",
  "simulator.semanticRank": "Semantic rank",
  "simulator.combinedScore": "Combined score",
  ...
  "trajectory.exitReplay": "Exit Replay",
  "trajectory.playReplay": "Play",
  "trajectory.pauseReplay": "Pause",
  "trajectory.prevStep": "Previous step",
  "trajectory.nextStep": "Next step",
  "trajectory.scrubberAria": "Scrub through events",
  "trajectory.speedLabel": "Playback speed",
  "trajectory.stepOf": "Step {{current}} of {{total}}",
  ...
  "activity.emptyDescription": "Activity will appear here as agents work.",
  ...
  "modes.tools": "Tools",
  "modes.deniedTools": "Denied Tools",
  "modes.deniedActions": "Denied Actions",
  "modes.requiredArtifact": "Required Artifact",
  ...
  "modes.form.deniedTools": "Denied Tools (comma-separated)",
  "modes.form.deniedToolsPlaceholder": "Write, Edit, Bash",
  "modes.form.deniedActions": "Denied Actions (comma-separated)",
  "modes.form.deniedActionsPlaceholder": "rm, curl, wget",
  "modes.form.requiredArtifact": "Required Artifact",
  ...
  "kb.emptyDescription": "Create a knowledge base to enhance agent context.",
  ...
  "kb.category.paradigm": "Paradigm",
  "kb.category.language": "Language",
  "kb.category.security": "Security",
  "kb.category.custom": "Custom",
  "kb.form.create": "Create Knowledge Base",
  "kb.form.name": "Name",
  "kb.form.description": "Description",
  ...
  // Scopes (Phase 12D)
  "scope.title": "Scopes",
  "scope.description": "Cross-project retrieval scope management",
  "scope.empty": "No scopes created yet",
  "scope.loading": "Loading scopes...",
  "scope.type.shared": "Shared",
  "scope.type.global": "Global",
  "scope.form.create": "Create Scope",
  ...
  "scope.toast.projectRemoved": "Project removed from scope",
  "scope.projects.count": "projects",
  "scope.projects.none": "No projects",
  "scope.search.title": "Search",
  "scope.search.hybrid": "Hybrid Search",
  "scope.search.graph": "Graph Search",
  "scope.search.query": "Search query",
  "scope.search.seedSymbols": "Seed symbols (comma-separated)",
  "scope.search.results": "results",
  "scope.search.noResults": "No results found",
  "scope.kbs.title": "Knowledge Bases",
  "scope.kbs.attach": "Attach",
  ...
  "mcp.emptyDescription": "Get started by adding your first MCP server.",
  ...
  "mcp.table.enabled": "Enabled",
  "mcp.table.actions": "Actions",
  "mcp.status.registered": "Registered",
  ...
  "mcp.form.descriptionPlaceholder": "What this MCP server provides...",
  ...
  "mcp.toast.created": "MCP server created",
  "mcp.toast.createFailed": "Failed to create MCP server",
  "mcp.toast.updated": "MCP server updated",
  "mcp.toast.updateFailed": "Failed to update MCP server",
  "mcp.toast.deleted": "MCP server deleted",
  "mcp.toast.deleteFailed": "Failed to delete MCP server",
  "mcp.toast.nameRequired": "Server name is required",
  "mcp.test": "Test",
  "mcp.testing": "Testing...",
  "mcp.testingConnection": "Testing connection...",
  "mcp.testSuccess": "Connection successful",
  "mcp.testSuccessTools": "Connected — {{count}} tools discovered",
  ...
  "mcp.deleteAria": "Delete server {{name}}",
  "mcp.tools": "Tools",
  "mcp.tools.loading": "Loading tools...",
  "mcp.tools.empty": "No tools discovered.",
  "mcp.tools.showTools": "Show Tools",
  "mcp.tools.hideTools": "Hide Tools",
  "mcp.tools.showToolsAria": "Show tools for {{name}}",
  "mcp.tools.hideToolsAria": "Hide tools for {{name}}",
  ...
  "prompts.emptyDescription": "Add prompt sections to customize agent behavior.",
  ...
  "benchmark.emptyDescription": "Run your first benchmark to evaluate agent quality.",
  ...
  "benchmark.compareResults": "Comparison Results",
  ...
  "benchmark.systemCost": "System Cost",
  "benchmark.noFallbacks": "No fallback events recorded.",
  "benchmark.taskId": "Task",
  "benchmark.primary": "Primary",
  "benchmark.fallbackTo": "Fallback",
  "benchmark.reason": "Reason",
  "benchmark.avgScore": "Avg Score",
  "benchmark.avgCost": "Avg Cost",
  "benchmark.percentage": "Share",
  ...
  "files.folderNamePlaceholder": "e.g. src/components",
  "files.createFolderSuccess": "Created folder {{name}}",
  ...
  "files.addedToContext": "Added to context: {{path}}",
  "files.rename": "Rename",
  "files.newName": "New name",
  "files.newNamePlaceholder": "Enter new name",
  "files.deleteFile": "Delete File",
  "files.deleteFolder": "Delete Folder",
  "files.deleteConfirm": "Are you sure you want to delete",
  "files.deleteFolderWarning": "This will delete all files inside the folder.",
