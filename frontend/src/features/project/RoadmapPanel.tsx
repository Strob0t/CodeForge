  ...
  return (
    <div class="rounded-lg border border-gray-200 bg-white p-4">
      ...
      <Show
        ...
        fallback={
          <div>
            <p class="mb-3 text-sm text-gray-500">No roadmap yet.</p>
            <div class="flex flex-col gap-2">
              ...
              <div class="flex gap-2">
                ...
                <button
                  class="rounded bg-gray-100 px-4 py-1.5 text-sm hover:bg-gray-200 disabled:opacity-50"
          ...
          <>
            <div class="mb-4 flex items-center justify-between">
              ...
              <div class="flex gap-2">
                ...
                <button
                  class="rounded bg-red-50 px-3 py-1 text-xs text-red-600 hover:bg-red-100"
            ...
            <Show when={rm().description}>
              <p class="mb-3 text-sm text-gray-500">{rm().description}</p>
            </Show>
            ...
            <Show when={aiPreview()}>
              <div class="mb-4 rounded border border-purple-200 bg-purple-50 p-3">
                <div class="mb-2 flex items-center justify-between">
                  <span class="text-xs font-medium text-purple-700">AI View (Markdown)</span>
                  <button
                ...
                <pre class="max-h-48 overflow-auto whitespace-pre-wrap text-xs text-gray-700">
                  {aiPreview()}
                </pre>
              </div>
            </Show>
              ...
              {(m: Milestone) => (
                <div class="mb-3 rounded border border-gray-100 bg-gray-50 p-3">
                  ...
                  <Show when={m.description}>
                    <p class="mb-2 text-xs text-gray-500">{m.description}</p>
                  </Show>
                  ...
                  <div class="space-y-1">
                    <For each={m.features ?? []}>
                      {(f: RoadmapFeature) => (
                        <div class="flex items-center justify-between rounded bg-white px-2 py-1.5 text-sm">
                          <div class="flex items-center gap-2">
                            <span
