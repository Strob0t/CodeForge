...
const BoundariesPanel = lazy(() => import("./BoundariesPanel"));
const LSPPanel = lazy(() => import("./LSPPanel"));
const RetrievalPanel = lazy(() => import("./RetrievalPanel"));
const SearchSimulator = lazy(() => import("./SearchSimulator"));
const TrajectoryPanel = lazy(() => import("./TrajectoryPanel"));
const WarRoom = lazy(() => import("./WarRoom"));

/** Fallback UI for lazy-loaded panels */
function PanelFallback() {
  return (
    <div class="flex items-center justify-center py-12">
      <LoadingState message="Loading panel..." />
    </div>
  );
}
