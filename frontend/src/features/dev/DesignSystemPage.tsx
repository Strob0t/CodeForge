    ...
    >
      ...
      >
        ...
        <DSSection
          id="typography"
          title="Typography"
          description="Display headings use Outfit. Body text uses IBM Plex Sans. Code uses the system monospace stack."
        >
          <div class="space-y-4">
            <div>
            ...
            <div>
              <p class="text-sm text-cf-text-primary">
                Body text (IBM Plex Sans) - The quick brown fox jumps over the lazy dog.
              </p>
