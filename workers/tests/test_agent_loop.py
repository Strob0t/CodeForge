...
class TestToolErrorTracker:
    def test_first_error_not_blocked(self) -> None:
        from codeforge.loop_helpers import ToolErrorTracker
    ...
    def test_normalize_strips_uuids(self) -> None:
        ...
        sig1 = ToolErrorTracker._normalize_error("Failed for id a1b2c3d4-e5f6 end")
        sig2 = ToolErrorTracker._normalize_error("Failed for id deadbeef-1234 end")
    ...
    def test_normalize_strips_line_numbers(self) -> None:
        ...
        sig1 = ToolErrorTracker._normalize_error("Error at line 42 col 10")
        sig2 = ToolErrorTracker._normalize_error("Error at line 999 col 5")
        assert sig1 == sig2
    ...
    def test_normalize_truncates_long_errors(self) -> None:
        ...
        long_error = "x" * 500
        sig = ToolErrorTracker._normalize_error(long_error)
        assert len(sig) <= 200
