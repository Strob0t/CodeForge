"""NATS stream and subject constants (single source of truth).

All NATS subject strings live here so they can be imported by any module
without triggering heavy package __init__ files (avoids circular imports).
"""
