...
func TestBuiltinModes_ExpectedPresets(t *testing.T) {
	expected := map[string]struct {
		...
		"proponent":          {true, true},
		"devops":             {true, false},
		"api_tester":         {true, false},
		"benchmarker":        {true, false},
		"frontend":           {true, false},
		"backend_architect":  {true, true},
		"lsp_engineer":       {true, true},
		"orchestrator":       {true, true},
		"evaluator":          {true, true},
		"workflow_optimizer": {true, true},
		"infra_maintainer":   {true, false},
		"prototyper":         {true, false},
		"goal_researcher":    {false, true},
		"boundary_analyzer":  {true, true},
		"contract_reviewer":  {true, true},
	}
