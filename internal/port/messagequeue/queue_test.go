...
func allSubjectConstants(t *testing.T) map[string]string {
	...
	subjects := map[string]string{
		...
		"SubjectMCPServerStatus":                mq.SubjectMCPServerStatus,
		"SubjectMCPToolDiscovery":               mq.SubjectMCPToolDiscovery,
		...
		"SubjectReviewBoundaryAnalyzed":         mq.SubjectReviewBoundaryAnalyzed,
		"SubjectReviewApprovalRequired":         mq.SubjectReviewApprovalRequired,
		"SubjectReviewApprovalResponse":         mq.SubjectReviewApprovalResponse,
