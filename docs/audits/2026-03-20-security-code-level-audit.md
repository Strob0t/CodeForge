...
> Warning: Score below 75 indicates significant security gaps that should be addressed before production deployment.
...
### CRITICAL-001: Password Reset Token Logged in Plaintext
...
### CRITICAL-002: store_agent_identity.go -- No Tenant Isolation (confirmed in Go Core Audit)
...
### HIGH-001: ReleaseStaleWork -- No Tenant Isolation
...
### HIGH-002: API Key Store -- No Tenant Isolation
...
### HIGH-003: NATS Payloads -- Tenant ID Trusted Without Verification (confirmed in NATS Audit)
...
### MEDIUM-001: WebSocket Auth Token in URL Query Parameter
...
### MEDIUM-002: Authentication Disabled by Default
...
### MEDIUM-003: Internal Service Key Grants Unrestricted Admin Access
...
### MEDIUM-004: CORS Wildcard Allowed Without Hard Block
...
### MEDIUM-005: User Store -- GetUser and DeleteUser Missing Tenant Isolation
...
### LOW-001: Refresh Cookie Secure Flag Conditional on TLS Detection
...
### LOW-002: Password Hash Returned in ListUsers API Response
